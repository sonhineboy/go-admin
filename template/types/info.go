...
func (i *InfoPanel) FieldFilterOnChooseAjax(field, url string, handler Handler, other ...string) *InfoPanel {
	...
	if len(other) == 2 {
		js, callback = chooseAjax(changeField, field, i.OperationURL(url), handler, template.HTML(other[1]))
	} else {
